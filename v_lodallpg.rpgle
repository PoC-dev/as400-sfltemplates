     HCOPYRIGHT('2007-2020 Patrik Schindler <poc@pocnet.net>')
     H*
     ...
     C*************************************************************************
     C     DUPREC        BEGSR
     C* Set "we wanna duplicate" flag and let CHGREC do the hard work.
     C                   MOVE      *ON           *IN78
     C                   EXSR      CHGREC
     C                   MOVE      *OFF          *IN78
     C*
